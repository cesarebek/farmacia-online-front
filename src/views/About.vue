<template>
  <div class="flex flex-col items-center">
    <div class=" text-center">
      ...
      >
        <p>Parafarmacia online</p>

        <span class="text-indigo-600"> realizzata da Bek Cezary</span>
      </h1>
      <p
        class="text-base text-gray-500 sm:text-lg max-w-xl mx-auto mt-5 md:text-xl mb-10"
      >
